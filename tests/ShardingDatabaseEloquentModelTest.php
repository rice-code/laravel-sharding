...
class ShardingDatabaseEloquentModelTest extends TestCase
{
    ...
    public function testNewInstanceReturnsNewInstanceWithTableSet()
    {
        ...
        $this->assertSame('test_' . Carbon::now()->format('ym'), $newInstance->getTable());
    }
    ...
    {
        $model = $this->getMockBuilder('Rice\LSharding\Tests\EloquentDateModelStub')->onlyMethods(['getDateFormat'])->getMock();
    ...
    {
        $model = new EloquentModelStub();
        $this->assertSame('stub_' . Carbon::now()->format('ym'), $model->getTable());
        $model->setTable('foo');
        $this->assertSame('foo_' . Carbon::now()->format('ym'), $model->getTable());
    }
    ...
    public function testQualifyColumn()
    {
        ...
        $this->assertSame('stub_' . Carbon::now()->format('ym') . '.column', $model->qualifyColumn('column'));
    }
    ...
    public function testModelObserversCanBeAttachedToModels()
    {
        ...
        $events->shouldReceive('listen')->once()->with('eloquent.creating: Rice\LSharding\Tests\EloquentModelStub', EloquentTestObserverStub::class . '@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: Rice\LSharding\Tests\EloquentModelStub', EloquentTestObserverStub::class . '@saved');
    ...
    public function testModelObserversCanBeAttachedToModelsThroughCallingObserveMethodOnlyOnce()
    {
        ...
        $events->shouldReceive('listen')->once()->with('eloquent.creating: Rice\LSharding\Tests\EloquentModelStub', EloquentTestAnotherObserverStub::class . '@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: Rice\LSharding\Tests\EloquentModelStub', EloquentTestAnotherObserverStub::class . '@saved');
    ...
    public function testWithoutEventDispatcher()
    {
        ...
        $events->shouldReceive('listen')->once()->with('eloquent.creating: Rice\LSharding\Tests\EloquentModelSaveStub', EloquentTestObserverStub::class . '@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: Rice\LSharding\Tests\EloquentModelSaveStub', EloquentTestObserverStub::class . '@saved');
        ...
        $events->shouldReceive('until')->once()->with('eloquent.saving: Rice\LSharding\Tests\EloquentModelSaveStub', $model);
        $events->shouldReceive('dispatch')->once()->with('eloquent.saved: Rice\LSharding\Tests\EloquentModelSaveStub', $model);
    ...
    public function testGetModelAttributeMethodThrowsExceptionIfNotRelation()
    {
        ...
        $this->expectExceptionMessage('Rice\LSharding\Tests\EloquentModelStub::incorrectRelationStub must return a relationship instance.');
    ...
    public function testModelAttributeCastingFailsOnUnencodableData()
    {
        ...
        $this->expectExceptionMessage('Unable to encode attribute [objectAttribute] for model [Rice\LSharding\Tests\EloquentModelCastingStub] to JSON: Malformed UTF-8 characters, possibly incorrectly encoded.');
...
class EloquentModelStub extends DatetimeSharding
{
    public $connection;
    public $scopesCalled = [];
