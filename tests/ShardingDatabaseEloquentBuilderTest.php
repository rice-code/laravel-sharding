...
class ShardingDatabaseEloquentBuilderTest extends TestCase
{
    ...
    {
        $builder = m::mock(EloquentBuilder::class . '[first]', [$this->getMockQueryBuilder()]);
    ...
    {
        // ids are not empty
        $builder = m::mock(EloquentBuilder::class . '[get]', [$this->getMockQueryBuilder()]);
    ...
    {
        $builder = m::mock(EloquentBuilder::class . '[get,take]', [$this->getMockQueryBuilder()]);
    ...
    {
        $builder = new EloquentBuilder(m::mock(BaseBuilder::class));
        $builder->shouldReceive('from')->with('foo_table');
    ...
    {
        $builder = m::mock(EloquentBuilder::class . '[getModels,eagerLoadRelations]', [$this->getMockQueryBuilder()]);
    ...
    {
        $builder                       = m::mock(EloquentBuilder::class . '[forPage,get]', [$this->getMockQueryBuilder()]);
    ...
    {
        $builder                       = m::mock(EloquentBuilder::class . '[forPageAfterId,get]', [$this->getMockQueryBuilder()]);
        $builder->getQuery()->orders[] = ['column' => 'foobar', 'direction' => 'asc'];
    ...
    public function testPluckReturnsTheMutatedAttributesOfAModel()
    {
        ...
        $builder->getModel()->shouldReceive('newFromBuilder')->with(['name' => 'bar'])->andReturn(new \Rice\LSharding\Tests\EloquentBuilderTestPluckStub(['name' => 'bar']));
    ...
    public function testPluckReturnsTheDateAttributesOfAModel()
    {
        ...
        $builder->getModel()->shouldReceive('newFromBuilder')->with(['created_at' => '2010-01-01 00:00:00'])->andReturn(new \Rice\LSharding\Tests\EloquentBuilderTestPluckDatesStub(['created_at' => '2010-01-01 00:00:00']));
    ...
    {
        $builder = m::mock(EloquentBuilder::class . '[eagerLoadRelation]', [$this->getMockQueryBuilder()]);
        $nop1    = function () {
        };
        $nop2 = function () {
        };
    ...
    {
        $builder = m::mock(EloquentBuilder::class . '[getRelation]', [$this->getMockQueryBuilder()]);
    ...
    public function testQueryScopes()
    {
        ...
        $builder->setModel($model = new \Rice\LSharding\Tests\EloquentBuilderTestScopeStub());
    ...
    {
        $model = new \Rice\LSharding\Tests\EloquentBuilderTestNestedStub();
    ...
    {
        $model = new \Rice\LSharding\Tests\EloquentBuilderTestHigherOrderWhereScopeStub();
        $this->mockConnectionForModel($model, 'SQLite');
    ...
    {
        $related = new \Rice\LSharding\Tests\EloquentBuilderTestWhereBelongsToStub([
            'id'        => 1,
            'parent_id' => 2,
        ]);
    ...
    {
        $model = new \Rice\LSharding\Tests\EloquentBuilderTestModelParentStub();
    ...
    {
        $model = new EloquentBuilderTestModelParentStub();
        \Rice\LSharding\Tests\EloquentBuilderTestModelCloseRelatedStub::addGlobalScope('withCount', function ($query) {
    ...
    {
        $model = new \Rice\LSharding\Tests\EloquentBuilderTestModelSelfRelatedStub();
    ...
    {
        $model   = new \Rice\LSharding\Tests\EloquentBuilderTestStubStringPrimaryKey();
        $builder = $this->getBuilder()->setModel($model);
        $keyName = $model->getQualifiedKeyName();
    ...
    public function testUpdate()
    {
        ...
        $model   = new \Rice\LSharding\Tests\EloquentBuilderTestStub();
        $this->mockConnectionForModel($model, '');
        $builder->setModel($model);
    ...
    public function testUpdateWithoutTimestamp()
    {
        $query   = new BaseBuilder(m::mock(ConnectionInterface::class), new Grammar(), m::mock(Processor::class));
        $builder = new Builder($query);
        $model   = new \Rice\LSharding\Tests\EloquentBuilderTestStubWithoutTimestamp();
        $this->mockConnectionForModel($model, '');
        $builder->setModel($model);
        $builder->getConnection()->shouldReceive('update')->once()
...
class EloquentBuilderTestModelParentStub extends Model
{
    ...
    public function roles()
    {
        return $this->belongsToMany(
            \Rice\LSharding\Tests\EloquentBuilderTestModelFarRelatedStub::class,
            'user_role',
            'self_id',
            'related_id'
        );
